...
Ces étapes permettent de reproduire un cycle complet : affectation d’une commande, livraison, synchronisation vers MongoDB et visualisation en temps réel.
...
Ces commandes permettent de tester les différentes parties indépendamment.
